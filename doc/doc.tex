...
Its predecessor, Secure Socket Layer (SSL) was replaced by TLS 1.0 in 1999. In 2018 the newest version 1.3 was implemented to reduce the overhead produced by the handshake.
